...
pub(crate) fn mcmf(n: usize, g: &[(usize, usize, i64, i64)], s: usize, t: usize) -> (i64, i64, Vec<Vec<(i64, i64)>>) {
    let mut cur_flow = 0;
    let mut cur_cost = 0;
    // adj. matrix
...
pub(crate) fn hopcroft_karp(u: usize, v: usize, g: &[(usize, usize)]) -> usize {
...
pub(crate) fn dinic(n: usize, g: &[(usize, usize, usize)], s: usize, t: usize) -> usize {
...
pub(crate) fn dinic2(n: usize, g: &[(usize, usize, usize)], s: usize, t: usize) -> (usize, Vec<bool>) {
    let mut f = vec![vec![0; n]; n];
    let mut adj = vec![vec![]; n];
    let level = vec![0usize; n];
    let ptr = vec![0usize; n];
